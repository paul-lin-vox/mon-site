            ...
            <div class="relative bg-gray-50 p-8 rounded-xl shadow-lg">
                ...
                <form action="send.php" method="post" >
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Jean Dupont" required>
                    </div>
                    <div class="mb-6">
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Votre email</label>
                        <input type="email" id="email" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="jean.dupont@exemple.com" required>
                    </div>
                    <div class="mb-6">
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Sujet</label>
                        <input type="text" id="subject" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="De quoi souhaitez-vous parler ?" required>
                    </div>
                    <div class="mb-6">
                        <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Votre message</label>
                        <textarea id="message" rows="4" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Décrivez-nous votre projet..." required></textarea>
                    </div>
                    <button type="submit" class="w-full bg-blue-600 text-white px-6 py-3 rounded-md font-medium hover:bg-blue-700 transition duration-300">Envoyer le message</button>
                </form>
              <?php if (isset($_GET['success']) && $_GET['success'] == 'true'): ?>
              <p style="color: green; font-weight: bold;">✅ Merci ! Votre message a bien été envoyé.</p>
              <?php endif; ?>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-6">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">contact@elpton.com</p>
                    </div>
                </div>
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">+225 71 29 76 635</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-5" aria-label="Réseaux sociaux">
          ...
          <a href="#" class="text-slate-300 hover:text-white" aria-label="X / Twitter">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-5 h-5" aria-hidden="true"><path d="M17.5 3H21l-6.9 7.9L22.8 21h-6.4l-5.1-6-5.9 6H3l7.4-8.4L1.5 3h6.5l4.5 5.3L17.5 3z"/></svg>
          </a>
